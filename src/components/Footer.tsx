        ...
        <div className="center-cards-grid">
          ...
          <div className="center-card teal">
            ...
            <div className="center-card-body">
              ...
              <div className="center-info-list">
                ...
                <div className="center-info-item">
                  ...
                  <p className="info-text">
                    <a href="mailto:Sales@agentifyaiglobal.com" className="center-link">Sales@agentifyaiglobal.com</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="center-card blue">
            ...
            <div className="center-card-body">
              <div className="center-header-row">
                <span className="center-badge blue">BANGALORE</span>
                <div className="center-icon-wrapper blue">
                  <svg className="center-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                    <circle cx="12" cy="10" r="3"></circle>
                  </svg>
              ...
              <h3 className="center-company">DV Data & Analytics Private Limited Bangalore</h3>
          ...
          <div className="center-card purple">
            ...
            <div className="center-card-body">
              <div className="center-header-row">
                <span className="center-badge purple">BHUBNESHWAR</span>
                <div className="center-icon-wrapper purple">
                  <svg className="center-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                    <circle cx="12" cy="10" r="3"></circle>
                  </svg>
              ...
              <h3 className="center-company">DV Data & Analytics Private Limited Bhubneshwar</h3>
              ...
              <div className="center-info-list">
                <div className="center-info-item">
                  ...
                  <p className="info-text">
                    Plot No A/7 : Adjacent to Maharaja Cine Complex,<br />
                    Bhoinagar, Acharya Vihar<br />
                    Bhubneshwar 751022, India
                  </p>
                </div>
